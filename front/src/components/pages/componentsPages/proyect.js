    ...
    return (
        <div className='proyectDivBody'>
            <form className='proyectFrom'>
                ...
                <input type="text" name="name" placeholder="Nombre" required className="name input" />
                <input type="email" name="email" placeholder="Correo" required className='email input' />
